...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center overflow-hidden w-full text-gray-700 dark:text-white"
    >
      <motion.div
      ...
      <motion.h1
        ...
        viewport={{ once: true }}
        className=" text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-bold xl:leading-23.75 max-w-5xl pb-4"
      >
