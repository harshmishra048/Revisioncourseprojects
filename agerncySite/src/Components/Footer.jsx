...
const Footer = ({ theme }) => {
  ...
  return (
    <>
      ...
      {/* Success Popup */}
      {showPopup && (
        <div className="fixed bottom-6 right-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-4 rounded-2xl shadow-2xl z-50 transition-all duration-500 animate-bounce">
